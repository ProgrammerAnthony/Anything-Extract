...
# 将 dependent_server 根目录和 ocr_server 目录加入 sys.path
_ocr_server_dir = os.path.dirname(os.path.abspath(__file__))
_dependent_server_dir = os.path.dirname(_ocr_server_dir)
for _p in (_dependent_server_dir, _ocr_server_dir):
...
from server_config import OCR_MODEL_PATH
import numpy as np
