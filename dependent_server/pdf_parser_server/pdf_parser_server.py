...
# 将 dependent_server 根目录和 pdf_parser_server 目录加入 sys.path
_pdf_server_dir = os.path.dirname(os.path.abspath(__file__))
_dependent_server_dir = os.path.dirname(_pdf_server_dir)
for _p in (_dependent_server_dir, _pdf_server_dir):
...
from pdf_parser_backend import PdfLoader
import time
import torch
import argparse
